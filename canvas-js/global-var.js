  ...
  //  word:  Term to search for
{
  ...
  //  Check for emoticon first

  if ( ( term = emoji_find_word( word ) ) != -1 ) {
    return term;
  }

  //  Next, check for ANEW word, then stems and words in ANEW, ANEW-EX,
  //  and Happiness dictionaries
  ...
  if ( ( term = anew_find_word( word ) ) != -1 ) {
    ...
    } else if ( ( term = happiness_find_stem( stem_term ) ) != -1 ) {
    } else {
